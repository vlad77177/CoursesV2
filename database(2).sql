...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 24 2018 г., 15:28
...
(8, 'Введение в компьютерный дизайн', 0),
(9, 'Пустой тестовый курс', 0);
...
--
-- Триггеры `gen_questions_temp`
--
DELIMITER $$
CREATE TRIGGER `deleteVariants` AFTER DELETE ON `gen_questions_temp` FOR EACH ROW BEGIN
...
(17, 8, 0, 117, 'Введение'),
(18, 8, 1, 118, 'История шрифта'),
(19, 8, 2, 119, 'Упаковка'),
(20, 9, 0, 259, 'Новый урок'),
(21, 9, 1, 260, 'Новый урок'),
(22, 9, 2, 261, 'Новый урок');
...
(56, 14, 1, 'Вопрос 1', 222),
(57, 14, 2, 'Вопрос 2', 223),
(58, 14, 3, 'Вопрос 3', 224),
(59, 14, 4, 'Вопрос 4', 225),
(60, 14, 5, 'Вопрос 5', 226),
(61, 15, 1, 'Вопрос 1', 263),
(62, 15, 2, 'Вопрос 2', 264),
(63, 15, 3, 'Вопрос 3', 265);
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `createQuestionCheckActive` AFTER INSERT ON `questions` FOR EACH ROW BEGIN
...
(14, 'Тест по курсу 1', 0, 1, 0, 0, 8, 0, 0, 1, 5, 4, 60),
(15, 'заглушка', 0, 1, 1, 1, 9, 0, 0, 1, 3, 2, 10);
...
INSERT INTO `test_history` (`id`, `user_id`, `name`, `data_start`, `data_end`, `time_limit`, `question_count`, `threshold`, `answers`) VALUES
(6, 23, 'Тест по курсу 1', '2018-08-24 11:06:17', '2018-08-24 11:06:32', 60, 5, 4, 4),
(7, 23, 'Тест по курсу 1', '2018-08-24 11:41:07', '2018-08-24 11:41:24', 60, 5, 4, 5),
(8, 23, 'заглушка', '2018-08-24 13:10:14', '2018-08-24 13:10:20', 10, 3, 2, 3),
(9, 23, 'заглушка', '2018-08-24 13:10:41', '2018-08-24 13:10:48', 10, 3, 2, 2),
(10, 23, 'заглушка', '2018-08-24 13:10:52', '2018-08-24 13:10:58', 10, 3, 2, 0),
(11, 23, 'Тест по курсу 1', '2018-08-24 13:25:31', '2018-08-24 13:25:41', 60, 5, 4, 5),
(12, 23, 'Тест по курсу 1', '2018-08-24 13:26:32', '2018-08-24 13:26:41', 60, 5, 4, 5),
(13, 23, 'заглушка', '2018-08-24 13:27:44', '2018-08-24 13:27:51', 10, 3, 2, 3),
(14, 23, 'Тест по курсу 1', '2018-08-24 14:16:34', '2018-08-24 14:17:08', 60, 5, 4, 5);

--
-- Триггеры `test_history`
--
DELIMITER $$
CREATE TRIGGER `deleteHistory` AFTER DELETE ON `test_history` FOR EACH ROW DELETE FROM test_history_questions WHERE id_history=OLD.id
$$
DELIMITER ;
...
--
-- Дамп данных таблицы `test_history_questions`
--

INSERT INTO `test_history_questions` (`id`, `id_history`, `number`, `text`) VALUES
(26, 6, 1, '<p>Какой простейший объект визуального дизайна?</p>\n'),
(27, 6, 2, '<p>Где зародился предшественник современного письма?</p>\n'),
(28, 6, 3, '<p>Где берет свое начало дизайн?</p>\n'),
(29, 6, 4, '<p>Выберите верные утверждения:</p>\n'),
(30, 6, 5, '<p>Где была изобретена бумага</p>\n'),
(31, 7, 1, '<p>Какой простейший объект визуального дизайна?</p>\n'),
(32, 7, 2, '<p>Где зародился предшественник современного письма?</p>\n'),
(33, 7, 3, '<p>Где берет свое начало дизайн?</p>\n'),
(34, 7, 4, '<p>Выберите верные утверждения:</p>\n'),
(35, 7, 5, '<p>Где была изобретена бумага</p>\n'),
(36, 8, 1, '<p>Введите текст вопроса 2</p>\n'),
(37, 8, 2, '<p>Введите текст вопроса 3</p>\n'),
(38, 8, 3, '<p>Введите текст вопроса 1</p>\n'),
(39, 9, 1, '<p>Введите текст вопроса 3</p>\n'),
(40, 9, 2, '<p>Введите текст вопроса 2</p>\n'),
(41, 9, 3, '<p>Введите текст вопроса 1</p>\n'),
(42, 10, 1, '<p>Введите текст вопроса 3</p>\n'),
(43, 10, 2, '<p>Введите текст вопроса 2</p>\n'),
(44, 10, 3, '<p>Введите текст вопроса 1</p>\n'),
(45, 11, 1, '<p>Какой простейший объект визуального дизайна?</p>\n'),
(46, 11, 2, '<p>Где берет свое начало дизайн?</p>\n'),
(47, 11, 3, '<p>Где была изобретена бумага</p>\n'),
(48, 11, 4, '<p>Где зародился предшественник современного письма?</p>\n'),
(49, 11, 5, '<p>Выберите верные утверждения:</p>\n'),
(50, 12, 1, '<p>Какой простейший объект визуального дизайна?</p>\n'),
(51, 12, 2, '<p>Где зародился предшественник современного письма?</p>\n'),
(52, 12, 3, '<p>Где берет свое начало дизайн?</p>\n'),
(53, 12, 4, '<p>Выберите верные утверждения:</p>\n'),
(54, 12, 5, '<p>Где была изобретена бумага</p>\n'),
(55, 13, 1, '<p>Введите текст вопроса 3</p>\n'),
(56, 13, 2, '<p>Введите текст вопроса 2</p>\n'),
(57, 13, 3, '<p>Введите текст вопроса 1</p>\n'),
(58, 14, 1, '<p>Какой простейший объект визуального дизайна?</p>\n'),
(59, 14, 2, '<p>Где зародился предшественник современного письма?</p>\n'),
(60, 14, 3, '<p>Где берет свое начало дизайн?</p>\n'),
(61, 14, 4, '<p>Выберите верные утверждения:</p>\n'),
(62, 14, 5, '<p>Где была изобретена бумага</p>\n');

--
-- Триггеры `test_history_questions`
--
DELIMITER $$
CREATE TRIGGER `deleteVariantsH` AFTER DELETE ON `test_history_questions` FOR EACH ROW DELETE FROM test_history_variants WHERE id_question=OLD.id
$$
DELIMITER ;
...
--
-- Структура таблицы `test_history_variants`
--
...
--
-- Дамп данных таблицы `test_history_variants`
--

INSERT INTO `test_history_variants` (`id`, `id_question`, `text`, `number`, `isright`, `answer`) VALUES
(81, 26, '<p>Точка</p>\n', 1, 1, 1),
(82, 26, '<p>Линия</p>\n', 2, 0, 0),
(83, 26, '<p>Круг</p>\n', 3, 0, 0),
(84, 27, '<p>В Византии</p>\n', 1, 0, 1),
(85, 27, '<p>В Греции</p>\n', 2, 0, 0),
(86, 27, '<p>В Древнем Египте</p>\n', 3, 1, 0),
(87, 28, '<p>В Германии</p>\n', 1, 0, 0),
(88, 28, '<p>Во Франции</p>\n', 2, 0, 0),
(89, 28, '<p>В Англии</p>\n', 3, 1, 1),
(90, 29, '<p>Дизайн складывается в процессе развития художественных программ, а так же инженерного проектирования.</p>\n', 1, 1, 1),
(91, 29, '<p>Дизайн зародился во Франции</p>\n', 2, 0, 0),
(92, 29, '<p>Компьютерный дизайн &mdash; художественно-проектная деятельность по созданию гармоничной и эффективной визуально-коммуникативной среды</p>\n', 3, 1, 1),
(93, 29, '<p>В компьютерном дизайне используется только растровая графика</p>\n', 4, 0, 0),
(94, 30, '<p>В Индии</p>\n', 1, 0, 0),
(95, 30, '<p>В Японии</p>\n', 2, 0, 0),
(96, 30, '<p>В Китае</p>\n', 3, 1, 1),
(97, 31, '<p>Линия</p>\n', 1, 0, 0),
...
(99, 31, '<p>Круг</p>\n', 3, 0, 0),
(100, 32, '<p>В Греции</p>\n', 1, 0, 0),
(101, 32, '<p>В Византии</p>\n', 2, 0, 0),
(102, 32, '<p>В Древнем Египте</p>\n', 3, 1, 1),
(103, 33, '<p>В Германии</p>\n', 1, 0, 0),
(104, 33, '<p>Во Франции</p>\n', 2, 0, 0),
(105, 33, '<p>В Англии</p>\n', 3, 1, 1),
(106, 34, '<p>В компьютерном дизайне используется только растровая графика</p>\n', 1, 0, 0),
(107, 34, '<p>Дизайн зародился во Франции</p>\n', 2, 0, 0),
(108, 34, '<p>Компьютерный дизайн &mdash; художественно-проектная деятельность по созданию гармоничной и эффективной визуально-коммуникативной среды</p>\n', 3, 1, 1),
(109, 34, '<p>Дизайн складывается в процессе развития художественных программ, а так же инженерного проектирования.</p>\n', 4, 1, 1),
(110, 35, '<p>В Индии</p>\n', 1, 0, 0),
(111, 35, '<p>В Японии</p>\n', 2, 0, 0),
(112, 35, '<p>В Китае</p>\n', 3, 1, 1),
(113, 36, '<p>Введите текст варианта t</p>\n', 1, 1, 1),
(114, 36, 'Введите текст варианта', 2, 0, 0),
(115, 36, 'Введите текст варианта', 3, 0, 0),
(116, 36, '<p>Введите текст варианта t</p>\n', 4, 1, 1),
(117, 37, 'Введите текст варианта', 1, 0, 0),
(118, 37, 'Введите текст варианта', 2, 0, 0),
(119, 37, 'Введите текст варианта', 3, 0, 0),
(120, 37, '<p>Введите текст варианта t</p>\n', 4, 1, 1),
(121, 38, '<p>Введите текст варианта t</p>\n', 1, 1, 1),
(122, 38, 'Введите текст варианта', 2, 0, 0),
(123, 38, 'Введите текст варианта', 3, 0, 0),
(124, 39, 'Введите текст варианта', 1, 0, 0),
(125, 39, 'Введите текст варианта', 2, 0, 1),
(126, 39, '<p>Введите текст варианта t</p>\n', 3, 1, 0),
(127, 39, 'Введите текст варианта', 4, 0, 0),
(128, 40, '<p>Введите текст варианта t</p>\n', 1, 1, 1),
(129, 40, 'Введите текст варианта', 2, 0, 0),
(130, 40, 'Введите текст варианта', 3, 0, 0),
(131, 40, '<p>Введите текст варианта t</p>\n', 4, 1, 1),
(132, 41, '<p>Введите текст варианта t</p>\n', 1, 1, 1),
(133, 41, 'Введите текст варианта', 2, 0, 0),
(134, 41, 'Введите текст варианта', 3, 0, 0),
(135, 42, 'Введите текст варианта', 1, 0, 1),
(136, 42, '<p>Введите текст варианта t</p>\n', 2, 1, 0),
(137, 42, 'Введите текст варианта', 3, 0, 0),
(138, 42, 'Введите текст варианта', 4, 0, 0),
(139, 43, 'Введите текст варианта', 1, 0, 1),
(140, 43, '<p>Введите текст варианта t</p>\n', 2, 1, 1),
(141, 43, '<p>Введите текст варианта t</p>\n', 3, 1, 0),
(142, 43, 'Введите текст варианта', 4, 0, 0),
(143, 44, 'Введите текст варианта', 1, 0, 0),
(144, 44, 'Введите текст варианта', 2, 0, 1),
(145, 44, '<p>Введите текст варианта t</p>\n', 3, 1, 0),
(146, 45, '<p>Линия</p>\n', 1, 0, 0),
(147, 45, '<p>Точка</p>\n', 2, 1, 1),
(148, 45, '<p>Круг</p>\n', 3, 0, 0),
(149, 46, '<p>В Германии</p>\n', 1, 0, 0),
(150, 46, '<p>Во Франции</p>\n', 2, 0, 0),
(151, 46, '<p>В Англии</p>\n', 3, 1, 1),
(152, 47, '<p>В Китае</p>\n', 1, 1, 1),
(153, 47, '<p>В Индии</p>\n', 2, 0, 0),
(154, 47, '<p>В Японии</p>\n', 3, 0, 0),
(155, 48, '<p>В Древнем Египте</p>\n', 1, 1, 1),
(156, 48, '<p>В Греции</p>\n', 2, 0, 0),
(157, 48, '<p>В Византии</p>\n', 3, 0, 0),
(158, 49, '<p>В компьютерном дизайне используется только растровая графика</p>\n', 1, 0, 0),
(159, 49, '<p>Дизайн зародился во Франции</p>\n', 2, 0, 0),
(160, 49, '<p>Компьютерный дизайн &mdash; художественно-проектная деятельность по созданию гармоничной и эффективной визуально-коммуникативной среды</p>\n', 3, 1, 1),
(161, 49, '<p>Дизайн складывается в процессе развития художественных программ, а так же инженерного проектирования.</p>\n', 4, 1, 1),
(162, 50, '<p>Круг</p>\n', 1, 0, 0),
(163, 50, '<p>Линия</p>\n', 2, 0, 0),
(164, 50, '<p>Точка</p>\n', 3, 1, 1),
(165, 51, '<p>В Византии</p>\n', 1, 0, 0),
(166, 51, '<p>В Древнем Египте</p>\n', 2, 1, 1),
(167, 51, '<p>В Греции</p>\n', 3, 0, 0),
(168, 52, '<p>В Германии</p>\n', 1, 0, 0),
(169, 52, '<p>В Англии</p>\n', 2, 1, 1),
(170, 52, '<p>Во Франции</p>\n', 3, 0, 0),
(171, 53, '<p>Дизайн складывается в процессе развития художественных программ, а так же инженерного проектирования.</p>\n', 1, 1, 1),
(172, 53, '<p>В компьютерном дизайне используется только растровая графика</p>\n', 2, 0, 0),
(173, 53, '<p>Компьютерный дизайн &mdash; художественно-проектная деятельность по созданию гармоничной и эффективной визуально-коммуникативной среды</p>\n', 3, 1, 1),
(174, 53, '<p>Дизайн зародился во Франции</p>\n', 4, 0, 0),
(175, 54, '<p>В Индии</p>\n', 1, 0, 0),
(176, 54, '<p>В Японии</p>\n', 2, 0, 0),
(177, 54, '<p>В Китае</p>\n', 3, 1, 1),
(178, 55, '<p>Введите текст варианта t</p>\n', 1, 1, 1),
(179, 55, 'Введите текст варианта', 2, 0, 0),
(180, 55, 'Введите текст варианта', 3, 0, 0),
(181, 55, 'Введите текст варианта', 4, 0, 0),
(182, 56, '<p>Введите текст варианта t</p>\n', 1, 1, 1),
(183, 56, 'Введите текст варианта', 2, 0, 0),
(184, 56, '<p>Введите текст варианта t</p>\n', 3, 1, 1),
(185, 56, 'Введите текст варианта', 4, 0, 0),
(186, 57, '<p>Введите текст варианта t</p>\n', 1, 1, 1),
(187, 57, 'Введите текст варианта', 2, 0, 0),
(188, 57, 'Введите текст варианта', 3, 0, 0),
(189, 58, '<p>Точка</p>\n', 1, 1, 1),
(190, 58, '<p>Линия</p>\n', 2, 0, 0),
(191, 58, '<p>Круг</p>\n', 3, 0, 0),
(192, 59, '<p>В Византии</p>\n', 1, 0, 0),
(193, 59, '<p>В Древнем Египте</p>\n', 2, 1, 1),
(194, 59, '<p>В Греции</p>\n', 3, 0, 0),
(195, 60, '<p>В Германии</p>\n', 1, 0, 0),
(196, 60, '<p>В Англии</p>\n', 2, 1, 1),
(197, 60, '<p>Во Франции</p>\n', 3, 0, 0),
(198, 61, '<p>Дизайн складывается в процессе развития художественных программ, а так же инженерного проектирования.</p>\n', 1, 1, 1),
(199, 61, '<p>Дизайн зародился во Франции</p>\n', 2, 0, 0),
(200, 61, '<p>Компьютерный дизайн &mdash; художественно-проектная деятельность по созданию гармоничной и эффективной визуально-коммуникативной среды</p>\n', 3, 1, 1),
(201, 61, '<p>В компьютерном дизайне используется только растровая графика</p>\n', 4, 0, 0),
(202, 62, '<p>В Китае</p>\n', 1, 1, 1),
(203, 62, '<p>В Японии</p>\n', 2, 0, 0),
(204, 62, '<p>В Индии</p>\n', 3, 0, 0);
...
--
-- Триггеры `test_session_temp`
--
DELIMITER $$
CREATE TRIGGER `deleteSession` AFTER DELETE ON `test_session_temp` FOR EACH ROW BEGIN
...
INSERT INTO `users` (`id`, `login`, `password`, `name`, `surname`, `email`, `administrator`, `curator`, `teacher`, `student`, `last_visit`) VALUES
(3, 'admin', '$2y$10$LgoYtUeoZBPDDQv4MBcu.e01Rh0NBXvE9gJ5ziKYFG4KmhQeUGK7O', 'Админ', 'Админ', 'admin@admin.com', 1, 0, 0, 0, '2018-08-24 14:31:39'),
(19, 'curator', '$2y$10$rO/PIqm8jLNixtxC2Fw9pesz3hRvAAApIDnOs/m.I.Hh7lRj4Qm9S', 'Сергей', 'Сергеев', 'c', 0, 1, 0, 0, '2018-08-24 11:03:16'),
(20, 'curator2', '$2y$10$/4ufycEzNUP4FNCT9UJKS.LAhiWpobjwW0HIB26BFdvy5IBQf7ySi', 'Иван', 'Иванов', 'c2', 0, 1, 0, 0, '0000-00-00 00:00:00'),
(21, 'teacher1', '$2y$10$hXf4LuJ5aC2TlrCZSYmKKubbEr27wh6pu.QGYqYCipFquglss634C', 'Василий', 'Орлов', 'teacher1', 0, 0, 1, 0, '0000-00-00 00:00:00'),
(22, 'teacher2', '$2y$10$kQOgHx88mftnZDRKO4vbD.OcMY0B26UM3ZtX.viUt2xiIs86LjPKq', 'Алексей', 'Алексеев', 'teacher2', 0, 0, 1, 0, '0000-00-00 00:00:00'),
(23, 'student1', '$2y$10$G5mhalaWcaNd7qHQvD7p9OQJl9krryLEK5aCECRYK6XwC10vj9Rw.', 'Валентин', 'Петров', 'st1', 0, 0, 0, 1, '2018-08-24 14:52:27'),
(24, 'student2', '$2y$10$ztBDpVs8GAiqA2eSPJfXAuiY98kC4jTJAb/7kQJZh/CtXQtbp0lju', 'Александр', 'Сидоров', 'st2', 0, 0, 0, 1, '0000-00-00 00:00:00'),
(25, 'student3', '$2y$10$s3Qstpuqwljv56z0CVQ/beoH/mSNeUZTxQVRQ3iQbuicTVC9l5/XC', 'Сергей', 'Жуков', 'st3', 0, 0, 0, 1, '0000-00-00 00:00:00'),
(26, 'teacher3', '$2y$10$td/e3OQ10Zk03jo54J.kcueb9ZMkyPjzUNDXBNmEVnfALpt5/sOpi', 'Геннадий', 'Онуфриев', 't3', 0, 0, 1, 0, '0000-00-00 00:00:00'),
(27, 'teacher4', '$2y$10$VrwyhyJ9kMh5tYNAEjhGA.FZozSb8zXDGEL/yAu/7xoI6I.oeTrve', 'Андрей', 'Орлов', 'andrey@andrey.ru', 0, 0, 1, 0, '0000-00-00 00:00:00'),
(28, 'student4', '$2y$10$JkcS.50QX1Epf4Fzqn0Shu9Od3THYYrH596G23rIoG76L9yrtbV0i', 'Вася', 'Пупкин', 'vasya@vasya.ru', 0, 0, 0, 1, '0000-00-00 00:00:00'),
(29, 'student5', '$2y$10$YLmfhq2JAmEKDkrW3fNlKuw7chFy25RkF7CRp.P25aNe9fzsAWDOm', 'Вася', 'Васильев', 'vasya@yandex.ru', 0, 0, 0, 1, '0000-00-00 00:00:00');
...
(16, 23, 8, 2, 5, 1, 14, 0, 7),
(17, 24, 8, 0, NULL, 1, NULL, NULL, NULL),
(21, 23, 9, 0, 3, 1, 15, 0, 6);
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `createVariantCheckActive` AFTER INSERT ON `variants` FOR EACH ROW BEGIN
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `deleteTextV` AFTER DELETE ON `variants` FOR EACH ROW BEGIN
	DELETE FROM text WHERE id_text=OLD.id_text;
    /**
    SET @max=(SELECT COUNT(*) FROM variants WHERE OLD.id_question);
    SET @i=1;
    
    WHILE @i<@max DO
    	UPDATE variants SET OLD.number=@i WHERE OLD.number<@i;
        SET @i=@i+1;
        END WHILE;**/
END
$$
...
ALTER TABLE `gen_questions_ansver_temp`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniqueRecord` (`id_gen_question`,`ansver`);
...
--
-- Индексы таблицы `test_history_variants`
--
ALTER TABLE `test_history_variants`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `test_history_variants`
--
ALTER TABLE `test_history_variants`
...
--
ALTER TABLE `text`
  MODIFY `id_text` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=278;
